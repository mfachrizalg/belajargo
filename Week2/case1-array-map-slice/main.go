...
func main() {
	...
	// Jawab : Karena panjang array yang dideklarasikan tidak sesuai dengan jumlah elemen yang diberikan
	...
	// Jawab : Terdapat kesalahan logika pada penempatan append, seharusnya ditempatkan di dalam kondisi if
	var primes []int
	for i := 10; i < 30; i++ {
		if i%2 != 0 && i%3 != 0 && i%5 != 0 && i%7 != 0 {
			primes = append(primes, i) // (seharusnya ditempatkan disini)
		}
		//primes = append(primes, i) (salah logika)
	}
